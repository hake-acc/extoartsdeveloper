      ...
      <section style={{ padding: 'min(18vh,130px) min(20px,5%) min(100px,10vw)', maxWidth: 820, margin: '0 auto', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
          {[
            ...
            { num: '2', title: 'Information We Collect', content: 'We collect: Account information (name, email, username, password hash) when you register on the portal; Dashboard data (order details, project files, chat messages) generated through portal use; Analytics data (page views, session duration, browser type, approximate location) collected through Google Analytics 4; Technical data (IP address, cookies, browser fingerprint) collected automatically.' },
            ...
            { num: '5', title: 'Cookies, Local Storage & Analytics', content: 'We use: PHP session cookies (required for authentication, expire on browser close); a localStorage key "extoArtsTerms" (to track terms acceptance); and Google Analytics 4 for traffic analysis (anonymized, with IP masking). You can opt out of Google Analytics at tools.google.com/dlpage/gaoptout. You can clear localStorage at any time through your browser settings.' },
            { num: '6', title: 'Third-Party Service Providers', content: 'We share data with: Discord (project communication, order tickets); Supabase (database hosting, PostgreSQL storage); Google Analytics (anonymized traffic analytics); Payment processors (PayPal, UPI, crypto processors - see their respective privacy policies); Cloudflare (DDoS protection, Turnstile CAPTCHA); Google Fonts and Font Awesome/cdnjs (typography, served via CDN); iili.io/freeimage.host (image hosting for portfolio and OG images); File transfer services (WeTransfer, Google Drive for footage delivery).' },
