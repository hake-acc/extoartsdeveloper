      ...
      <section style={{ padding: 'min(18vh,130px) min(20px,5%) min(100px,10vw)', maxWidth: 820, margin: '0 auto', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
          {[
            ...
            { num: '5', title: 'Cookies & Analytics', content: 'We use Google Analytics 4 for traffic analysis (anonymized, with IP masking). You can opt out of Google Analytics at tools.google.com/dlpage/gaoptout. We do not use persistent cookies or localStorage to track preferences or store identifiers.' },
