      ...
      <section style={{ padding: 'min(18vh,130px) min(20px,5%) min(100px,10vw)', maxWidth: 820, margin: '0 auto', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
          {[
            ...
            { num: '3', title: 'Official Channels', content: 'All official ExtoArts communication occurs through: (1) The ExtoArts Discord server (discord.gg/extoarts-1402333030827425922), (2) The ExtoArts client portal at extoarts.in/dashboard, and (3) The official support email at support@extoarts.in. Communications through other platforms are not binding on ExtoArts.' },
