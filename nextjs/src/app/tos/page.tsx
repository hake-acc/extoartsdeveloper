      ...
      <section style={{ padding: 'min(18vh,130px) min(20px,5%) min(100px,10vw)', maxWidth: 820, margin: '0 auto', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
          {[
            ...
            { num: '3', title: 'Official Channels', content: 'official-channels' },
            ...
            { num: '22', title: 'Contact', content: null },
          ].map((section) => (
            <section key={section.num} id={`tos-${section.num}`} style={{ scrollMarginTop: 90 }}>
              ...
              <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: 1.78, margin: 0 }}>
                {section.content === 'official-channels' ? (
                  <>
                    All official ExtoArts communication occurs through: (1) The ExtoArts Discord server (discord.gg/extoarts-1402333030827425922), and (2) The official support email at{' '}
                    <ObfuscatedEmail user="support" domain="extoarts.in" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 700 }} />
                    . Communications through other platforms are not binding on ExtoArts.
                  </>
                ) : section.content ?? (
                  <>
                    For questions about these Terms of Service, contact ExtoArts at{' '}
                    <ObfuscatedEmail user="support" domain="extoarts.in" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 700 }} />
                    {' '}or through the Discord server.
                  </>
                )}
              </p>
            </section>
