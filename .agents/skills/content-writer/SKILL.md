...
- [Measurement Protocol](shared-references/measurement-protocol.md) — refresh readback windows (7/14/28/56 days) and judging impact against a control
- [Humanizer Slop Check](shared-references/humanizer-slop.md) — pre-publish self-check that strips AI-slop phrasing before handoff
